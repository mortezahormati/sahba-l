    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header  sahba-card-header">
                <h5 class="card-title text-white">'{{ __('admin.categories.updateCategory')}}  &nbsp;  {{ $subCategory->title }}</h5>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12 mt-3">
                        ...
                        <form wire:submit.prevent="updateSubCategory" class="padding-30">
                            @include('errors.errors')
                            <div class="form-group">
                                <input wire:model.lazy="subCategory.title" type="text"
                            ...
                            <div class="form-group">
                                <select wire:model.defer="subCategory.parent" type="text" name="parent" class="form-control" >
                            ...
                            <div class="form-group mt-5">
                                <div class="row wrapper-sahba">
                                    <div class="switch_box  col-md-12 ">
                                        ...
                                        <div class="col-md-3">
                                            <input type="checkbox" wire:model.lazy="subCategory.status" name="status" class="switch_1">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <img class="thumbnail-img-category" src="{{ asset('storage/'.$subCategory->img) }}" style="height: 100px;" alt="">
