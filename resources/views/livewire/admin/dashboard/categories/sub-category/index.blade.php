@section('title', __('admin.categories.subCategories.subCategories'))
@section('css')
...
<div class="row" >
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12 mt-3">
                        <form wire:submit.prevent="subCategoryForm" class="padding-30" id="createForm">
                            @include('errors.errors')
                            <div class="form-group">

                                <input type="text" wire:model.lazy="subCategory.title"
                                       placeholder="{{ __('admin.categories.subCategories.title') }}"
                                       name="title" class="text form-control">
                            </div>
                            <div class="form-group">
                                <input wire:model.lazy="subCategory.name" type="text"
                                       placeholder="{{ __('admin.categories.subCategories.name') }}"
                                       name="name" class="text form-control">
                            </div>
                            <div class="form-group">
                                <input wire:model.lazy="subCategory.link" type="text"
                                       placeholder="{{ __('admin.categories.subCategories.link') }}"
                                       name="link" class="text form-control">
                            </div>
                            <div class="form-group">
                                <select wire:model.defer="subCategory.parent" type="text" name="parent"
                                        class="form-control">
                                    ...
                                    <div class="switch_box  col-md-12 ">
                                        <div class="col-md-6">
                                            <label for="sahba-checkbox"
                                                   class="font-size-5 "><small>@lang('admin.categories.subCategories.status')</small></label>
                                        </div>
                                        <div class="col-md-3"></div>
                                        <div class="col-md-3">
                                            <input type="checkbox" wire:model.lazy="subCategory.status" name="status"
                                                   class="switch_1">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group mt-5 text-center">
                                <button class="btn  btn-outline-dark "
                                        id="formSubmit">@lang('admin.categories.subCategories.addSubCategories')</button>
                            </div>
                        </form>
                    </div>
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header sahba-card-header">
                <h5 class="card-title text-white">@lang('admin.categories.subCategories.subCategories')</h5>
                <div class="card-tools">
                    <button type="button" class="btn btn-tool" data-widget="collapse">
                        <i class="fa fa-minus"></i>
                    </button>
            ...
            <div class="card-body">
                <div class="row mb-4 mt-3">
                    <div class="col-md-5">
                        ...
                        <a class="btn btn-outline-dark ml-2 active" href="{{ route('sub-categories.index')}}">
                    ...
                    <div class="col-md-2 text-left">
                        <a class="btn btn-danger trash-link text-white"
                           href="{{ route('sub-categories.trash')}}">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped text-center">
                                    ...
                                    <tr role="row" class="title-row">
                                        ...
                                        <th>@lang('admin.categories.subCategories.name')</th>
                                        <th>@lang('admin.categories.subCategories.parent')</th>
                                        <th>@lang('admin.categories.subCategories.status')</th>
                                    ...
                                    @foreach($subCategories as $c)
                                        <tr role="row">
                                            ...
                                            <td>
                                                @if($c->status == 1 )
                                                    <button type="submit"
                                                            wire:click="disableSubCategoryStatus({{$c->id}})"
                                                            class="badge badge-success bg-success">{{ __('admin.categories.statusActive') }}
                                                    </button>
                                                @else
                                                    <button wire:click="enableSubCategoryStatus({{$c->id}})"
                                                            type="submit"
                                            ...
                                            <td>
                                                @if($c->status == 0)
                                                    <a type="submit" wire:click="deleteSubCategory({{ $c->id }})"
                                                       class="ml-2 text-danger "
                                                       title="حذف">
                                                        <i class="fa fa-remove"></i>
                                                    </a>
                                                    <a type="button" href="{{ route('subCategories.update-form',$c) }}"
