@section('title' , __('admin.categories.subCategories.childSubCategories.trash-child-sub-categories'))
@section('css')
                                    ...
                                    <table class="table table-striped text-center ">
                                        ...
                                        @foreach($childSubCategories as $c)
                                            <tr role="row">
                                                ...
                                                <td>
                                                    <a type="submit" wire:click="forceDeleteChildSubCategory({{ $c->id }})"
                                                       class="text-danger"
                                                    ...
                                                    <a type="submit"
                                                       ...
                                                       wire:click="restoreChildSubCategory({{ $c->id }})">
