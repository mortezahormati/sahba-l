...
<div class="sidebar__nav border-top border-left  ">
    ...
    <div class="profile__info border cursor-pointer text-center">
        <div class="avatar__img">
            ...
            @else
                <img src="{{ asset('image/1.png') }}" class="avatar___img">
            @endif
        ...
        <span
            class="profile__name">{{ auth()->user() ? auth()->user()->user_name  : auth()->user()->phone_number }}</span>
    </div>
	<!-- Component Start -->
	<div class="flex flex-col items-center w-16 h-full overflow-hidden text-gray-400 bg-gray-900 rounded">
		...
		<div class="flex flex-col items-center mt-3 border-t border-gray-700">
			<a class="flex items-center justify-center w-4 h-4 mt-2 rounded hover:bg-gray-700 hover:text-gray-300" href="#">
			...
			<a class="flex items-center justify-center w-4 h-4 mt-2 text-gray-200 bg-gray-700 rounded" href="#">
				<svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
