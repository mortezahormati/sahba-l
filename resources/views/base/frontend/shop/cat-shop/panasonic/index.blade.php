...
@section('chapternav')
    <div class="subnav design-and-advertisement trans active">
        <div class="container-fluid sub-menu-products">
            <ul>
                <li>
                    <a href="{{ route('cat.shop.index' , 'panasonic') }}" style="background: none;color: #0d0d0d">
                        <span>پاناسونیک</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('cat.shop.index' , 'bosch') }}" style="background: none;color: #0d0d0d">
                        <span>بوش</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('cat.shop.index' , 'v-tech') }}" style="background: none;color: #0d0d0d">
                        <span>وی تک</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('cat.shop.index' , 'fine') }}" style="background: none;color: #0d0d0d">
                        <span>فاین </span>
                    </a>
                </li>
            </ul>
    ...
    <div class="subnav design-and-advertisement trans active sub-sub-menu">
        <div class="container-fluid sub-menu-products">
            <ul>
                @foreach($sub_child_categories as $sub)
                <li>
                    <a href="" style="background: none;color: #0d0d0d">
                        @isset($sub->img)
                            <img
                                 src="{{ asset('storage/'.$sub->img) }}"
                                 style="width: 24px;vertical-align: after-edge" alt="">
                        @endisset
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-4 col-xs-12 float-right sticky-sidebar"
            ...
            @include('base.frontend.shop.cat-shop.panasonic.side-bar')
        </div>
