...
@section('title' , __('admin.side-bar.colors'))
@section('css')
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header  sahba-card-header">
                    <h5 class="card-title text-white">@lang('admin.colors.add-color')</h5>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 mt-3">
                            ...
                            <form id="createForm" action="{{ route('colors.create') }}" method="post"
                                ...
                                <table id="myForm" class="table table-striped text-center">
                                    ...
                                    @foreach($colors as $c)
                                        <tr role="row">
                                            ...
                                            <td>
                                                <div class="result-status-{{ $c->id }}">
                                                    <a href=""
                                                       class="status-active badge {{ $c->status==1 ? 'bg-success' :'bg-danger' }}
                                                           ">
                                            ...
                                            <td>
                                                <div class="">
                                                    <form method="POST" id="remove-color-{{$c->id}}"  action="{{route('colors.destroy',['color'=>$c->id])}}" style='display:inline' >
                                                        {{method_field('delete')}}
                                                        @csrf
                                                    ...
                                                    <a  class="open-pracavailable btn text-success" data-toggle="modal"  href="#pracavailable" data-id={{$c->id }} >
                                                        <i class="fa fa-edit"></i>
                                                    </a>

{{--                                                    <a data-toggle="modal" data-target="#edit_color_modal" data-color-id="{{$c->id}}" title="ویرایش کاربر" class="p-1 text-success">--}}
{{--                                                       --}}
{{--                                                    </a>--}}
                                                </div>
                                            </td>
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <button type="button" class="close closed-removed" data-dismiss="modal" aria-label="Close">
...
{{--                        <div class="modal fade" id="edit_color_modal" tabindex="-1" role="dialog" aria-hidden="true">--}}
{{--                            <div class="modal-dialog modal-lg" role="document">--}}
{{--                                <div class="modal-content">--}}
{{--                                    <div class="modal-header">--}}
{{--                                        <div class="row">--}}
...
{{--                                            </div>--}}
{{--                                            <div class="col-md-10">--}}
{{--                                                <h6 class="modal-title text-center">ویرایش کاربر</h6>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
...
{{--                                        <button class="btn btn-danger standard-btn float-left" data-dismiss="modal">بازگشت</button>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
