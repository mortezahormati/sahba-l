<form action="{{ route('updating-user-profile' , $user) }}" method="post" id="userNameCreate">
    @csrf
    <div class="modal fade text-right" id="ModalUserNameCreate" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-md-12">
                        <p class="small">لطفا اطلاعات شناسایی خود را وارد کنید. نام و نام خانوادگی شما باید با اطلاعاتی
                    ...
                    <div class="row col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="product"
                                       class="font-size-5 ">نام خانوادگی
                                </label>
                                <input type="text"
                                       placeholder=""
                                       name="family" class="text form-control">
                            </div>
                        </div>
                    </div>
        ...
        <script>
            $('#userNameCreate').validate({
                ...
                messages:{
                    ...
                    family : {
                        required : "فیلد نام خانوادگی  الزمی می باشد!",
                        minlength : "فیلد نام خانوادگی حداقل سه کاراکتر می باشد! ",
                        lettersonly : "فیلد نام خانوادگی شامل حروف فارسی میشود!",
                    }
                }
            })
        </script>
