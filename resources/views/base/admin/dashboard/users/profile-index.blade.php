                                    ...
                                    <div class="row gutters-sm">
                                        <div class="col-md-6" style="border: .2px dashed #d2eac2;border-radius: 8px">
                                            <div class="row">
                                                ...
                                                <div class="col-md-2  mt-5">
                                                    <a href="" class="" data-toggle="modal" data-target="#ModalCompanyPhoneNumber"><img
                                                            src="{{ asset('icons/edit-32.png') }}" alt="" width="20px"></a>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="tab-pane" id="address">
                        ...
                        <div class="row mt-2">
                            @foreach($user->userAddresses as $a)
                                ...
                                <div class="col-md-2 ">
                                    <a href="{{ route('user-profile-remove-address' , $a) }}" class="text-bold font-size-12 text-red" style="float: left"><i class="fa fa-remove color-red"></i></a>
                                </div>
...
{{--                            </div>--}}
    ...
    @include('base.admin.dashboard.users.modal.user-name')
    @include('base.admin.dashboard.users.modal.phone-number')
    @include('base.admin.dashboard.users.modal.national-code')
    @include('base.admin.dashboard.users.modal.birthday')
    @include('base.admin.dashboard.users.modal.email')
    @include('base.admin.dashboard.users.modal.juridical-knowledge')
    @include('base.admin.dashboard.users.modal.password')
    @include('base.admin.dashboard.users.modal.address')
    @include('base.admin.dashboard.users.modal.profile-image')
    @include('base.admin.dashboard.users.company-modal.name')
    @include('base.admin.dashboard.users.company-modal.job')
    @include('base.admin.dashboard.users.company-modal.national_code')
    @include('base.admin.dashboard.users.company-modal.phone_number')
