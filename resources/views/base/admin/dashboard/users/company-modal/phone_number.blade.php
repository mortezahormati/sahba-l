<form action="{{ route('update-user-company-profile' , $user) }}" method="post" id="phoneUpdate">
@csrf
    <div class="modal fade text-right" id="ModalCompanyPhoneNumber" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-md-12">
                        <p class="small">لطفا اطلاعات تلفن ثابت  خود را وارد کنید.
                        </p>
                    </div>
