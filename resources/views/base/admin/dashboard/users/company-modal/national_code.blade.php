<form action="{{ route('update-user-company-profile' , $user) }}" method="post" id="nationalCodeUpdate">
@csrf
    <div class="modal fade text-right" id="ModalCompanyNationalCode" tabindex="-1" role="dialog" aria-hidden="true">
