    ...
    <div class="container">
        <div class="footer-inner-box">
            <a href="#" class="footer-badge">
                <img src="{{ asset('forntend/assets/images/footer-svg/delivery.svg') }}" alt="badge">
                <span class="item-feature">تحویل اکسپرس</span>
            </a>

            <a href="#" class="footer-badge">
                <img src="{{ asset('forntend/assets/images/footer-svg/contact-us.svg') }}" alt="badge">
                <span class="item-feature">پشتیبانی 24 ساعته</span>
            </a>

            <a href="#" class="footer-badge">
                <img src="{{ asset('forntend/assets/images/footer-svg/payment-terms.svg') }}" alt="badge">
                <span class="item-feature">پرداخت در منزل</span>
            </a>

            <a href="#" class="footer-badge">
                <img src="{{ asset('forntend/assets/images/footer-svg/return-policy.svg') }}" alt="badge">
                <span class="item-feature">7 روز ضمانت برگشت</span>
            </a>

            <a href="#" class="footer-badge">
                <img src="{{ asset('forntend/assets/images/footer-svg/origin-guarantee.svg') }}" alt="badge">
    ...
    <div class="col-12">
        <div class="footer-address">
            ...
            <div class="address-images">
                <a href="#">
                    <img src="{{ asset('forntend/assets/images/footer-img/1090a120.png') }}" alt="address">
                    <img src="{{ asset('forntend/assets/images/footer-img/71abe5c9.png') }}" alt="address">
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="more-info">
        <div class="col-12">
            <div class="about-site">
                ...
                <div class="footer-inner-box">
                    <a href="#" class="footer-badge">
                        <img src="{{ asset('forntend/assets/images/footer-svg/footer-1.svg') }}" style="width: 130px !important;"
                             alt="badge">
                    </a>

                    <a href="#" class="footer-badge">
                        <img src="{{ asset('forntend/assets/images/footer-svg/footer-2.svg') }}" style="width: 130px !important;"
                             alt="badge">
                    </a>

                    <a href="#" class="footer-badge">
                        <img src="{{ asset('forntend/assets/images/footer-svg/footer-3.svg') }}" style="width: 130px !important;"
                             alt="badge">
                    </a>

                    <a href="#" class="footer-badge">
                        <img src="{{ asset('forntend/assets/images/footer-svg/footer-4.svg') }}" style="width: 130px !important;"
                             alt="badge">
                    </a>
                    <a href="#" class="footer-badge">
                        <img src="{{ asset('forntend/assets/images/footer-svg/footer-5.svg') }}" style="width: 130px !important;"
                             alt="badge">
                    </a>
                </div>
            </div>
